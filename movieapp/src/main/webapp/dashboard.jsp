...
<body>
	<header id="main-header">
		<img src="https://tse1.mm.bing.net/th?id=OIP.0XgyB45NrL0bCsYPM_MBAQHaFj&pid=Api&P=0&h=180" alt="Logo"> <input type="text"
	...
	<main id="main-body">
		<section id="main-showcase">
			<h1>Movies</h1>
			<form action="/movieapp/movie.app/movieServlet" id="seelectedMovieForm">
				 ...
				 System.out.println("Total No Of Movies:"+movieList.size());
		            for(Movie m:movieList){
						...
						<div id="<%=m.getMovieID() %>" class="box" onclick="showMovieInfoPage(this.id)">
							...
							<h4>Movie Rating: <%out.write(m.getMovieRating()); %></h4>
						</div>
